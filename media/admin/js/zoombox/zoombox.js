...
var width;
var height;
var timer;          // Timing for images loading
...
function gallery(){
    ...
    if(options.gallery){
        ...
        for(var i in imageset){
            ...
            img.click(function(){
               ...
               $('#zoombox .zoombox_gallery images').removeClass('current');
            ...
            $("<img/>").data('img',img).attr("src", imgSrc).load(function() {
                    ...
                    if(loaded == $('#zoombox .zoombox_gallery images').length){
                        var width = 0; 
                        $('#zoombox .zoombox_gallery images').each(function(){
    ...
    $('#zoombox').bind('change',function(e,css){
        ...
        var decal = - $('#zoombox .zoombox_gallery images.current').data('left') + $('#zoombox .zoombox_gallery images.current').width() / 2;
...
function open(){
    ...
    $('#zoombox .close').hide();
    $('#zoombox .zoombox_container').removeClass('multimedia').removeClass('images').addClass(type);
    ...
    if(type=='images' && isOpen == false && options.animation == true){
        $('#zoombox .zoombox_content').append(content);
    }
    // Default position/size of the box to make the "zoom effect"
    if(elem != null && elem.find('images').length != 0 && isOpen == false){
        var min = elem.find('images');
    ...
    if(options.animation == true){
        ...
        $('#zoombox .zoombox_container').animate(css,options.duration,function(){
            ...
            if(type == 'image' || isOpen == true){
                $('#zoombox .zoombox_content images').css('opacity',0).fadeTo(300,1);
            }
...
function close(){
    ...
    var css = {};
    if(elem != null && elem.find('images').length > 0){
        var min = elem.find('images');
        css ={
            width : min.width(),
            height: min.height(),
...
function gotoSlide(i){
    ...
    link = elem.attr('href');
    if($('#zoombox .zoombox_gallery images').length > 0){
        $('#zoombox .zoombox_gallery images').removeClass('current');
        $('#zoombox .zoombox_gallery images:eq('+i+')').addClass('current');
    }
    load();
    return false;
}
