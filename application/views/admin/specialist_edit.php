...
<script>
    $(document).ready(function(){
        ...
        CKEDITOR.replace( 'pagecontent_small', config);
...
<form method="post" id="editpage" action="">
    ...
    <div class="bloc">
        <div class="title">Краткое содержание "<?=$page->name?>"</div>
        <div class="content">
            <textarea id="pagecontent_small" name="smalltext"><?=$page->smalltext?></textarea>
