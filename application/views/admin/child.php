 ...
 */?>
<div class="cb"></div>
<a href="/uniqbox/modal/new_for_parent/<?=$page->id?>" class="zoombox w600 h800"><img src="/media/admin/images/icons/button-add.png" border="0" /> ДОБАВИТЬ ЕЛЕМЕНТ</a>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="padding: 0 20px;" class="actions">
                ...
                <a title="Свойства (название, url)" class="zoombox w600 h800" href="/uniqbox/modal/new_for_parent/<?=$page->id?>/?el_id=<?=$nw->id?>"><img src="/media/admin/images/icons/actions/edit.png" /></a>
