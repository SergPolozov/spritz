...
if($nw->url != 'main'){
?>
                    <a title="Свойства (название, url)" class="zoombox w600 h800" href="/uniqbox/modal/new_for_module/<?=$module->url?>/?el_id=<?=$nw->id?>"><img src="/media/admin/images/icons/actions/edit.png" /></a>
                    <a title="Удалить" class="ajax" answer="Элемент успешно удален" action="/uniqbox/modules/<?=$module->url?>/" href="/uniqbox/modal/delete_element/?el_id=<?=$nw->id?>"><img src="/media/admin/images/icons/actions/delete.png" /></a>
<?php
}
?>
                </td>
